...
const Layout: React.FC<IProps> = ({
  ...
  return (
    <div className="flex h-screen bg-gray-100 border-t-4 border-main" style={customStyles}>
      ...
      <button
        type="button"
        className="fixed z-50 block rounded-full shadow-lg w-14 h-14 bottom-4 right-4 lg:hidden"
        style={{
          backgroundColor: primaryColor ? primaryColor : '#775ad8',
      ...
      <main
        className={classNames(
          'relative w-full lg:px-20 overflow-x-hidden bg-white rounded-l-2xl shadow-main',
          { 'overflow-hidden max-h-screen fixed': navIsOpen }
        )}
      >
        <div className="flex flex-col max-w-4xl min-h-screen py-12 mx-4 sm:py-16 sm:mx-8 md:mx-12 lg:m-auto lg:py-32">
