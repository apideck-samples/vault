const LoadingSuggestionCard = () => {
  return (
    <div className="relative w-full px-6 pt-6 pb-4 font-medium border border-gray-200 rounded-md cursor-pointer sm:w-44 xl:w-48 animate-pulse hover:shadow-md">
